...
[![Parity vs tmux](https://img.shields.io/badge/parity%20vs%20tmux-1194%2F1194%20(100%25)-brightgreen.svg)](parity/PARITY_ROADMAP.md)
...
>
> *"Ported against the C, verified against the C — byte for byte, 1194/1194 parity cases passing."*
...
parity suite is green at **1194/1194 (100%)** against the vendored tmux. Every bug the harness
...
**1194/1194 cases passing (100%), byte-for-byte vs the vendored tmux, with zero known
