...
[![Parity vs tmux](https://img.shields.io/badge/parity%20vs%20tmux-1124%2F1124%20(100%25)-brightgreen.svg)](parity/PARITY_ROADMAP.md)
...
>
> *"Ported against the C, verified against the C — byte for byte, 1124/1124 parity cases passing."*
...
parity suite is green at **1124/1124 (100%)** against the vendored tmux. Every bug the harness
...
**1124/1124 cases passing (100%), byte-for-byte vs the vendored tmux, with zero known
...
- **Ratatui UI** (on by default) — original interactive surfaces rendered with
  ...
  **edit-scrollback-in-`$EDITOR`** (`prefix e`), and **multi-pane selective sync** — mark panes
  ...
  output from a tiled pane never draws over the float.
