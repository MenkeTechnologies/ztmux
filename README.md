...
[![Parity vs tmux](https://img.shields.io/badge/parity%20vs%20tmux-1115%2F1115%20(100%25)-brightgreen.svg)](parity/PARITY_ROADMAP.md)
...
>
> *"Ported against the C, verified against the C — byte for byte, 1115/1115 parity cases passing."*
...
parity suite is green at **1115/1115 (100%)** against the vendored tmux. Every bug the harness
...
**1115/1115 cases passing (100%), byte-for-byte vs the vendored tmux, with zero known
