...
[![Parity vs tmux](https://img.shields.io/badge/parity%20vs%20tmux-1180%2F1180%20(100%25)-brightgreen.svg)](parity/PARITY_ROADMAP.md)
...
>
> *"Ported against the C, verified against the C — byte for byte, 1180/1180 parity cases passing."*
...
parity suite is green at **1180/1180 (100%)** against the vendored tmux. Every bug the harness
...
**1180/1180 cases passing (100%), byte-for-byte vs the vendored tmux, with zero known
