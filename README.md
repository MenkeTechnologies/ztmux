...
>
> *"Ported against the C, verified against the C — byte for byte, 1251/1251 parity cases passing."*
...
parity suite is green at **1251/1251 (100%)** against the vendored tmux. Every divergence the
