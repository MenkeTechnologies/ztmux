...
[![Parity vs tmux](https://img.shields.io/badge/parity%20vs%20tmux-1130%2F1130%20(100%25)-brightgreen.svg)](parity/PARITY_ROADMAP.md)
...
>
> *"Ported against the C, verified against the C — byte for byte, 1130/1130 parity cases passing."*
...
parity suite is green at **1130/1130 (100%)** against the vendored tmux. Every bug the harness
...
loop is Rust (`src/event_loop`, replacing tmux's libevent) and terminfo is read by
...
**1130/1130 cases passing (100%), byte-for-byte vs the vendored tmux, with zero known
...
exceptions (libc and event-loop wrappers, Rust glue) are frozen in
...
│   ├── event_loop/    # the event loop in Rust (replaces libevent); not a port
