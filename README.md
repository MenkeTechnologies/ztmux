...
[![Parity vs tmux](https://img.shields.io/badge/parity%20vs%20tmux-1621%2F1621%20gated%20%2B%2012%20quarantined-brightgreen.svg)](parity/PARITY_ROADMAP.md)
...
>
> *"Ported against the C, verified against the C — byte for byte, 1621/1621 gated parity cases passing."*
...
parity suite is green at **1621/1621 gated (100%)** against the vendored tmux, with **12
...
**1621/1621 gated cases passing (100%), byte-for-byte vs the vendored tmux**, plus **12
...
`docs/BUGS.md` keeps an open list. 73 of the cases compare what an ATTACHED CLIENT
