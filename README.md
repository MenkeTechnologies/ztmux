...
[![Parity vs tmux](https://img.shields.io/badge/parity%20vs%20tmux-1183%2F1183%20(100%25)-brightgreen.svg)](parity/PARITY_ROADMAP.md)
...
>
> *"Ported against the C, verified against the C — byte for byte, 1183/1183 parity cases passing."*
...
parity suite is green at **1183/1183 (100%)** against the vendored tmux. Every bug the harness
...
**1183/1183 cases passing (100%), byte-for-byte vs the vendored tmux, with zero known
