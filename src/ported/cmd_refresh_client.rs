...
/// C `vendor/tmux/cmd-refresh-client.c:47`: `static void cmd_refresh_client_update_subscription(struct client *tc, const char *value)`
...
/// C `vendor/tmux/cmd-refresh-client.c:82`: `static enum cmd_retval cmd_refresh_client_control_client_size(struct cmd *self, struct cmdq_item *item)`
...
/// C `vendor/tmux/cmd-refresh-client.c:134`: `static void cmd_refresh_client_update_offset(struct client *tc, const char *value)`
...
/// C `vendor/tmux/cmd-refresh-client.c:202`: `static enum cmd_retval cmd_refresh_client_exec(struct cmd *self, struct cmdq_item *item)`
