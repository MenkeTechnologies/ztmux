...
/// C `vendor/tmux/cmd-source-file.c:64`: `static enum cmd_retval cmd_source_file_complete_cb(struct cmdq_item *item, __unused void *data)`
...
/// C `vendor/tmux/cmd-source-file.c:81`: `static void cmd_source_file_complete(struct client *c, struct cmd_source_file_data *cdata)`
...
/// C `vendor/tmux/cmd-source-file.c:102`: `static void cmd_source_file_done(struct client *c, const char *path, int error, int closed, struct evbuffer *buffer, void *data)`
...
/// C `vendor/tmux/cmd-source-file.c:136`: `static void cmd_source_file_add(struct cmd_source_file_data *cdata, const char *path)`
...
/// C `vendor/tmux/cmd-source-file.c:145`: `static char *cmd_source_file_quote_for_glob(const char *path)`
...
/// C `vendor/tmux/cmd-source-file.c:160`: `static enum cmd_retval cmd_source_file_exec(struct cmd *self, struct cmdq_item *item)`
