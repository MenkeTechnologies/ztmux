...
/// C `vendor/tmux/cmd-show-options.c:77`: `static enum cmd_retval cmd_show_options_exec(struct cmd *self, struct cmdq_item *item)`
...
/// C `vendor/tmux/cmd-show-options.c:148`: `static void cmd_show_options_print(struct cmd *self, struct cmdq_item *item, struct options_entry *o, int idx, int parent)`
...
/// C `vendor/tmux/cmd-show-options.c:199`: `static enum cmd_retval cmd_show_options_all(struct cmd *self, struct cmdq_item *item, int scope, struct options *oo)`
