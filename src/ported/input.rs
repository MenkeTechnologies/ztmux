...
/// C `vendor/tmux/input.c:771`: `static int input_table_compare(const void *key, const void *value)`
...
/// C `vendor/tmux/input.c:820`: `static void input_reset_cell(struct input_ctx *ictx)`
...
/// Save screen state.
/// C `vendor/tmux/input.c:833`: `static void input_save_state(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:846`: `static void input_restore_state(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:860`: `struct input_ctx *input_init(struct window_pane *wp, struct bufferevent *bev, struct colour_palette *palette, struct client *c)`
...
/// C `vendor/tmux/input.c:888`: `void input_free(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:913`: `void input_reset(struct input_ctx *ictx, int clear)`
...
/// Return pending data.
/// C `vendor/tmux/input.c:937`: `struct evbuffer *input_pending(struct input_ctx *ictx)`
pub unsafe fn input_pending(ictx: *mut input_ctx) -> *mut evbuffer {
    unsafe { (*ictx).since_ground }
}

/// C `vendor/tmux/input.c:944`: `static void input_set_state(struct input_ctx *ictx, const struct input_transition *itr)`
...
/// Parse data.
/// C `vendor/tmux/input.c:955`: `static void input_parse(struct input_ctx *ictx, const u_char *buf, size_t len)`
...
/// C `vendor/tmux/input.c:1014`: `void input_parse_pane(struct window_pane *wp)`
...
/// Parse given input.
/// C `vendor/tmux/input.c:1026`: `void input_parse_buffer(struct window_pane *wp, const u_char *buf, size_t len)`
...
/// C `vendor/tmux/input.c:1056`: `void input_parse_screen(struct input_ctx *ictx, struct screen *s, screen_write_init_ctx_cb cb, void *arg, const u_char *buf, size_t len)`
...
/// C `vendor/tmux/input.c:1071`: `static int input_split(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1123`: `static int input_get(struct input_ctx *ictx, u_int validx, int minval, int defval)`
...
/// C `vendor/tmux/input.c:1207`: `static int input_print(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1232`: `static int input_intermediate(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1246`: `static int input_parameter(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1260`: `static int input_input(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1282`: `static int input_c0_dispatch(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1364`: `static int input_esc_dispatch(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1440`: `static int input_csi_dispatch(struct input_ctx *ictx)`
...
/// Handle CSI RM.
/// C `vendor/tmux/input.c:1876`: `static void input_csi_dispatch_rm(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1900`: `static void input_csi_dispatch_rm_private(struct input_ctx *ictx)`
...
/// Handle CSI SM.
/// C `vendor/tmux/input.c:1973`: `static void input_csi_dispatch_sm(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:1997`: `static void input_csi_dispatch_sm_private(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2078`: `static void input_csi_dispatch_sm_graphics(__unused struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2099`: `static void input_csi_dispatch_winops(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2199`: `static int input_csi_dispatch_sgr_256_do(struct input_ctx *ictx, int fgbg, int c)`
...
/// C `vendor/tmux/input.c:2221`: `static void input_csi_dispatch_sgr_256(struct input_ctx *ictx, int fgbg, u_int *i)`
...
/// C `vendor/tmux/input.c:2232`: `static int input_csi_dispatch_sgr_rgb_do(struct input_ctx *ictx, int fgbg, int r, int g, int b)`
...
/// C `vendor/tmux/input.c:2255`: `static void input_csi_dispatch_sgr_rgb(struct input_ctx *ictx, int fgbg, u_int *i)`
...
/// C `vendor/tmux/input.c:2268`: `static void input_csi_dispatch_sgr_colon(struct input_ctx *ictx, u_int i)`
...
/// Handle CSI SGR.
/// C `vendor/tmux/input.c:2356`: `static void input_csi_dispatch_sgr(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2507`: `static int input_end_bel(struct input_ctx *ictx)`
...
/// DCS string started.
/// C `vendor/tmux/input.c:2518`: `static void input_enter_dcs(struct input_ctx *ictx)`
...
/// OSC string started.
/// C `vendor/tmux/input.c:2663`: `static void input_enter_osc(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2674`: `static void input_exit_osc(struct input_ctx *ictx)`
...
/// APC string started.
/// C `vendor/tmux/input.c:2758`: `static void input_enter_apc(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2769`: `static void input_exit_apc(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2789`: `static void input_enter_rename(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2800`: `static void input_exit_rename(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2834`: `static int input_top_bit_set(struct input_ctx *ictx)`
...
/// C `vendor/tmux/input.c:2903`: `static void input_osc_4(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:2952`: `static void input_osc_8(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3045`: `static void input_osc_10(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3080`: `static void input_osc_110(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3096`: `static void input_osc_11(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3123`: `static void input_osc_111(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3139`: `static void input_osc_12(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3163`: `static void input_osc_112(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3171`: `static void input_osc_133(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3299`: `static void input_osc_104(struct input_ctx *ictx, const char *p)`
...
/// C `vendor/tmux/input.c:3336`: `void input_reply_clipboard(struct bufferevent *bev, const char *buf, size_t len, const char *end, char clip)`
