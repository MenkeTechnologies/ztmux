...
/// C `vendor/tmux/cmd-show-environment.c:69`: `static void cmd_show_environment_print(struct cmd *self, struct cmdq_item *item, struct environ_entry *envent)`
...
/// C `vendor/tmux/cmd-show-environment.c:98`: `static enum cmd_retval cmd_show_environment_exec(struct cmd *self, struct cmdq_item *item)`
