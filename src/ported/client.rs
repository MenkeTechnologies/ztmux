...
/// C `vendor/tmux/client.c:78`: `static int client_get_lock(char *lockfile)`
...
/// C `vendor/tmux/client.c:105`: `static int client_connect(struct event_base *base, const char *path, uint64_t flags)`
...
/// C `vendor/tmux/client.c:185`: `const char *client_exit_message(void)`
...
/// C `vendor/tmux/client.c:224`: `static void client_exit(void)`
...
/// C `vendor/tmux/client.c:232`: `int client_main(struct event_base *base, int argc, char **argv, uint64_t flags, int feat)`
pub unsafe extern "C-unwind" fn client_main(
    ...
    unsafe {
        ...
        {
            unsafe extern "C" {
                /// C `vendor/tmux/compat/systemd.c:39`: `int systemd_activated(void)`
...
/// C `vendor/tmux/client.c:450`: `static void client_send_identify(const char *ttynam, const char *termname, char **caps, u_int ncaps, const char *cwd, int feat)`
...
#[expect(clippy::deref_addrof)]
/// C `vendor/tmux/client.c:499`: `static __dead void client_exec(const char *shell, const char *shellcmd)`
...
/// C `vendor/tmux/client.c:520`: `static void client_signal(int sig)`
...
/// C `vendor/tmux/client.c:574`: `static void client_file_check_cb(__unused struct client *c, __unused const char *path, __unused int error, __unused int closed, __unused struct evbuffer *buffer, __unused void *data)`
...
/// C `vendor/tmux/client.c:584`: `static void client_dispatch(struct imsg *imsg, __unused void *arg)`
...
/// C `vendor/tmux/client.c:603`: `static void client_dispatch_exit_message(char *data, size_t datalen)`
...
#[expect(clippy::deref_addrof)]
/// C `vendor/tmux/client.c:629`: `static void client_dispatch_wait(struct imsg *imsg)`
...
#[expect(clippy::deref_addrof)]
/// C `vendor/tmux/client.c:727`: `static void client_dispatch_attached(struct imsg *imsg)`
