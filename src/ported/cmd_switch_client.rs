...
pub static CMD_SWITCH_CLIENT_ENTRY: cmd_entry = cmd_entry {
    ...
    args: args_parse::new("c:EFlnO:pt:rT:Z", 0, 0, None),
...
/// C `vendor/tmux/cmd-switch-client.c:49`: `static enum cmd_retval cmd_switch_client_exec(struct cmd *self, struct cmdq_item *item)`
