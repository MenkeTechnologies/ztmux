...
/// C `vendor/tmux/cmd-show-messages.c:49`: `static int cmd_show_messages_terminals(struct cmd *self, struct cmdq_item *item, int blank)`
...
/// C `vendor/tmux/cmd-show-messages.c:74`: `static enum cmd_retval cmd_show_messages_exec(struct cmd *self, struct cmdq_item *item)`
