...
pub unsafe fn key_bindings_unref_table(table: *mut key_table) {
    unsafe {
        ...
        crate::extensions::diagnostics::record_table_drop("key_bindings_unref_table freed", table);
...
pub unsafe fn key_bindings_remove(name: *const u8, key: key_code) {
    unsafe {
        ...
        {
            crate::extensions::diagnostics::record_table_drop("key_bindings_remove emptied the table", table.as_ptr());
...
pub unsafe fn key_bindings_remove_table(name: *const u8) {
    unsafe {
        ...
        if !table.is_null() {
            crate::extensions::diagnostics::record_table_drop("key_bindings_remove_table", table);
