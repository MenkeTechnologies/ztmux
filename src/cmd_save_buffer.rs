...
// vendor/tmux/cmd-save-buffer.c:59  static void cmd_save_buffer_done(__unused struct client *c, const char *path, int error, __unused int closed, __unused struct evbuffer *buffer, void *data)
...
// vendor/tmux/cmd-save-buffer.c:73  static enum cmd_retval cmd_save_buffer_exec(struct cmd *self, struct cmdq_item *item)
