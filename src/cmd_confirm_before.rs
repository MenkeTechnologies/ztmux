...
// vendor/tmux/cmd-confirm-before.c:60  static enum args_parse_type cmd_confirm_before_args_parse(__unused struct args *args, __unused u_int idx, __unused char **cause)
...
// vendor/tmux/cmd-confirm-before.c:67  static enum cmd_retval cmd_confirm_before_exec(struct cmd *self, struct cmdq_item *item)
...
// vendor/tmux/cmd-confirm-before.c:122  static enum prompt_result cmd_confirm_before_callback(struct client *c, void *data, const char *s, __unused enum prompt_key_result key)
...
// vendor/tmux/cmd-confirm-before.c:158  static void cmd_confirm_before_free(void *data)
