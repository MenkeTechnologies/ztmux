...
/// C `vendor/tmux/resize.c:26`: `void resize_window(struct window *w, u_int sx, u_int sy, int xpixel, int ypixel)`
...
/// C `vendor/tmux/resize.c:69`: `static int ignore_client_size(struct client *c)`
...
/// C `vendor/tmux/resize.c:99`: `static u_int clients_with_window(struct window *w)`
...
/// C `vendor/tmux/resize.c:114`: `static int clients_calculate_size(int type, int current, struct client *c, struct session *s, struct window *w, int (*skip_client)(struct client *, int, int, struct session *, struct window *), u_int *sx, u_int *sy, u_int *xpixel, u_int *ypixel)`
...
/// C `vendor/tmux/resize.c:267`: `static int default_window_size_skip_client(struct client *loop, __unused int type, __unused int current, struct session *s, struct window *w)`
...
/// C `vendor/tmux/resize.c:278`: `void default_window_size(struct client *c, struct session *s, struct window *w, u_int *sx, u_int *sy, u_int *xpixel, u_int *ypixel, int type)`
...
/// C `vendor/tmux/resize.c:337`: `static int recalculate_size_skip_client(struct client *loop, __unused int type, int current, __unused struct session *s, struct window *w)`
...
/// C `vendor/tmux/resize.c:353`: `void recalculate_size(struct window *w, int now)`
...
/// C `vendor/tmux/resize.c:420`: `void recalculate_sizes(void)`
...
/// C `vendor/tmux/resize.c:426`: `void recalculate_sizes_now(int now)`
