...
// vendor/tmux/cmd-display-message.c:53  static void cmd_display_message_each(const char *key, const char *value, void *arg)
...
// vendor/tmux/cmd-display-message.c:61  static enum cmd_retval cmd_display_message_exec(struct cmd *self, struct cmdq_item *item)
