...
// vendor/tmux/key-string.c:196  static key_code key_string_search_table(const char *string)
...
/// Find modifiers.
// vendor/tmux/key-string.c:213  static key_code key_string_get_modifiers(const char **string)
...
// vendor/tmux/key-string.c:243  key_code key_string_lookup_string(const char *string)
...
// vendor/tmux/key-string.c:327  const char *key_string_lookup_key(key_code key, int with_flags)
