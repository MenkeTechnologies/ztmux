...
// vendor/tmux/compat/base64.c:126  int b64_ntop(unsigned char const *src, size_t srclength, char *target, size_t targsize)
...
// vendor/tmux/compat/base64.c:187  int b64_pton(char const *src, unsigned char *target, size_t targsize)
