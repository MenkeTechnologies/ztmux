...
**1245/1245 cases pass (100%) vs the vendored tmux — zero known divergences.** The
suite grew from 122 → 380 → 646 → 661 → 665 → 675 → 680 → 684 → 686 → 689 → 774 → 840 → 900 → 1080 → 1107 → 1115 → 1121 → 1123 → 1130 → 1134 → 1166 → 1173 → 1178 → 1180 → 1183 → 1188 → 1193 → 1194 → 1201 → 1203 → 1205 → 1207 → 1240 → 1244 → 1245 cases.
...
proof. These gaps do not count against the 1245/1245 ported surface; they measure
